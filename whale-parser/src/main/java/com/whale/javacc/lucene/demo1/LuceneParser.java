/* Generated By:JavaCC: Do not edit this line. LuceneParser.java */
package com.whale.javacc.lucene.demo1;

public class LuceneParser implements LuceneParserConstants {
  public static void parse() throws ParseException
  {
    LuceneParser parser = new LuceneParser(System.in);
    while (true)
    {
  ...
  static public LuceneParserTokenManager token_source;
