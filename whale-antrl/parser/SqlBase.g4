...
statement
    ...
    | UPDATE qualifiedName SET updatedElements 
    ...
    | SHOW (SCHEMAS | DATABASES) ((FROM | IN) identifier)?
...
limitClause
    : LIMIT 
    (
      (offset=INTEGER_VALUE ',')? limit=(INTEGER_VALUE | ALL)
      | limit=(INTEGER_VALUE | ALL) OFFSET offset=INTEGER_VALUE
    )
    ;
...
updatedElements                                                            
    : updatedElement (',' updatedElement)*                                 #updateItems
    ;

updatedElement                                                            
    : qualifiedName EQ valueExpression                                     #updateItem
    ;
...
nonReserved
    ...
    | JSON
    | LAST | LATERAL | LEVEL | LIMIT | OFFSET | LOGICAL
    | MAP | MINUTE | MONTH
