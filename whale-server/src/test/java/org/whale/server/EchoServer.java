...
import org.whale.handler.demo.EchoOutHandler1;
import org.whale.handler.demo.EchoOutHandler2;
import org.whale.handler.demo.RequestMsgHandler;
import org.whale.handler.demo.RequestOpHandler;
        ...
        try {
            ...
            .childHandler(new ChannelInitializer<Channel>() {//设置childHandler执行所有的连接请求
                ...
                protected void initChannel(Channel ch) throws Exception {
                    ...
                    ch.pipeline().addLast(new RequestMsgHandler());
                    ch.pipeline().addLast(new EchoOutHandler1());
                    ch.pipeline().addLast(new EchoOutHandler2());
                    ch.pipeline().addLast(new RequestOpHandler());
